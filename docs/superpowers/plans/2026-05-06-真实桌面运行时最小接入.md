...
- [x] **Step 4: Implement mock status**
...
- [x] **Step 5: Run runtime metadata verification**
...
- [x] **Step 6: Commit runtime metadata and factory**
...
- [x] **Step 1: Add failing Tauri runtime tests**
...
- [x] **Step 4: Implement tauri runtime**
...
- [x] **Step 5: Run Tauri runtime verification**
...
- [x] **Step 6: Commit minimal Tauri runtime**
...
- [x] **Step 2: Run Store tests and confirm failure**
...
- [x] **Step 3: Refactor Store default runtime and status**
...
- [x] **Step 4: Add runtime validation before generation**
...
- [x] **Step 6: Commit Store runtime status integration**
...
- [x] **Step 1: Add failing Settings UI tests**
...
- [x] **Step 5: Run Settings verification**
...
- [x] **Step 6: Commit Settings runtime UI**
...
- [x] **Step 1: Rename spec to Chinese file name**
...
- [x] **Step 2: Update README runtime section**
